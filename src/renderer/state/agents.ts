...
const SEED_AGENTS: readonly SeedAgent[] = [
  ...
  // Phase 266: opencode's own lowercase spelling; order and unverified mirror
  // the registry row (conformance:agents §3 checks this).
  { id: 'opencode', label: 'opencode', unverified: false }
];
